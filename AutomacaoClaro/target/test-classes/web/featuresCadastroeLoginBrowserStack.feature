...
Funcionalidade: Realizar cadastro e efetuar login no site automationpractice
  ...
  Cenário de Fundo: 
    Dado que desejo efetuar o teste no navegador "Chrome" na máquina "BrowserStack"
  ...
  Delineação do Cenário: Efetuar cadastro no site automationpractice
    ...
    Exemplos: 
      ...
      | "testeautomacaoclaro6@mailinator.com" | "Eduardo" | "Oliveira" | "03/05/1998"       | "senhA123" | "11996826338" |
